  ...
  setCaptureMode(prevMode => {
   ...
   const [isUploadMenuVisible, setIsUploadMenuVisible] = useState(false);
    ...
    const handlePageDoubleClick = async (pageNumber) => {
      ...
      try {
        ...
        fabric.Image.fromURL(imageData, (img) => {
          ...
          img.strokeId = uniqueId; // Assign strokeId to the image object
    ...
    const {
      ...
      updateBrushSettings,
      setBroadcastDrawing,
    } = useFabricCanvas(canvasNode, initialDrawings, selectedTool, eraserMode, brushOpacity, brushColor, textSize);
